...
const { signingUp, commonSigningUp } = require("../services/auth.service");
...
const commonSignup = async (req, res, next) => {
  try {
    // credentials from the user
    ...
    // signing up the user
    const userId = await commonSigningUp(firstName, lastName, email, password);
...
module.exports = { signup, login, commonSignup, commonLogin };
